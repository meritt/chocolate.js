(function() {
  ...
  defaultOptions = {"actions":{"overlay":false,"leftside":"prev","container":"next","rightside":"close"},"thumbnails":true,"history":true,"repeat":true,"basedir":".."};
  ...
  "overlay": "
    <div class=\"choco-overlay\">
      <div class=\"choco-leftside choco-unselect\"></div>
      {{spinner}}
      <div class=\"choco-container choco-unselect\"></div>
      <div class=\"choco-header\"></div>
      <div class=\"choco-rightside choco-unselect\"></div>
      {{thumbnails}}
      <div class=\"choco-close choco-unselect\"></div>
    </div>
  ",
  ...
  "image-title": "<h1>{{title}}</h1><p class=\"choco-counter\">1 из 3</p>",

  "thumbnails": "<div class=\"choco-thumbnails choco-unselect\"></div><div class=\"choco-thumbnails-toggle choco-unselect\"></div>",
  ...
  Chocolate = (function() {
    ...
    */
    ...
    Chocolate.prototype.close = function() {
      if (this.overlay.hasClass('show')) {
        if (isHistory) history.pushState(null, null, '#');
    ...
    */
    ...
    Chocolate.prototype.updateImage = function(cid, updateHistory) {
      ...
      this.getImageSize(cid, function(cid) {
        ...
        return this.header.html(image.title ? templates['image-title'].replace('{{title}}', image.title) : '');
      });
      return this;
    };
    ...
    */
    ...
    Chocolate.prototype.updateDimensions = function(width, height) {
      var horizontal, innerHeight, innerWidth, left, style, thumbnails, title, top, vertical, windowHeight, windowWidth;
      title = !!this.images[this.current].title;
      thumbnails = !this.options.thumbnails || this.thumbnails.css('display') === 'none' ? 0 : this.thumbnails.height();
      horizontal = parseInt(this.overlay.css('padding-left'), 10) + parseInt(this.overlay.css('padding-right'), 10);
      vertical = parseInt(this.overlay.css('padding-top'), 10) + parseInt(this.overlay.css('padding-bottom'), 10);
      ...
      if (title) {
        this.header.css({
          ...
          'width': width,
          'margin-left': '-' + left + 'px',
          'padding-top': parseInt((height - 100) / 2, 10) + 'px'
        });
      } else {
        this.header.css({
          'display': 'none'
